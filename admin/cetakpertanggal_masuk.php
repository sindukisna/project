...
where tgl like '$_POST[tanggal]%' and jenis='Masuk' and username = '$username' order by kode asc") or die
(mysql_error());
...
<body onLoad="javascript:print()">   
							...
							<tr>
							<td><div align="center">
							  <h4 align="center" class="style1">Laporan Uang Masuk </h4></td>
							</tr>
							</table>
                        </div>
                        ...
                        <div class="panel-body">
						 <div class="col-lg-12">
                        	<div class="row">
							<center>Laporan Uang Masuk Per-Tanggal :  <?php echo TanggalIndo($_POST['tanggal']);?>
							</center>
										<br>
