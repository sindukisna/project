...
$editDb = mysql_fetch_assoc($edit);
	if($_POST["pasien"]){
			include_once("../library/koneksi.php");
			mysql_query("update uang set kategori='".$_POST["kategori"]."', judul='".$_POST["nama"]."',  tgl='".$_POST["tgl"]."', jumlah='".$_POST["usia"]."' where kode='".$_GET["nmr"]."'");
			echo "<meta http-equiv='refresh' content='0; url=?menu=uang_masuk'>";
		...
		<p style="margin-top:10px;">
			...
			<div class="form-group">
						...
						<div class="form-actions no-margin-bottom" style="text-align:center;">
							<input type="submit" name="pasien" value="Simpan" class="btn btn-primary" /> <a href="?menu=uang_masuk" class="btn btn-warning">Batal</a>
						</div>
