...
session_start();
	if($_POST["pasien"]){
			...
			mysql_query("insert into uang set kode='".$_POST["kode"]."', kategori='".$_POST["kategori"]."',judul='".$_POST["nama"]."', tgl='".$_POST["tgl"]."',jenis='Keluar',keluar='".$_POST["usia"]."'");
						echo("<script>
		...
		<div class="body">
			...
			<div class="form-group">
						...
						<div class="form-actions no-margin-bottom" style="text-align:center;">
							<input type="submit" name="pasien" value="Simpan" class="btn btn-primary" /> <a href="?menu=uang_keluar" class="btn btn-warning">Back</a>
						</div>
